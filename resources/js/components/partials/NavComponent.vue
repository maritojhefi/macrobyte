    ...
    <ul class="navbar-nav nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right p-0">
                <div class="dropdown-menu-grid">
                    <div class="menu-grid-row">
                        <div><a class="dropdown-item  border-bottom border-right" href=""><i class="la la-newspaper-o"></i><span>Mesas Activas</span></a></div>
                        <div><a class="dropdown-item  border-right" href=""><i class="zmdi zmdi-assignment-check zmdi-hc-fw"></i><span>Ventas del dia</span></a></div>

                     </div>
                  
                    <div class="menu-grid-row">
                      
                        <div><a class="dropdown-item  border-bottom" href=""><i class="la la-unlock-alt"></i><span>Abrir Caja Diaria</span></a></div>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                <div class="dropdown-header pb-3">
                    <div class="media d-user">
                        <img class="align-self-center mr-3 w-40 rounded-circle" src="" alt="Albert Einstein">
            ...
            <a class="dropdown-item" href=""><i class="icon dripicons-user"></i> Perfil</a>
                ...
                <a class="dropdown-item" href=""><i class="icon dripicons-gear"></i>Cuentas Activas</a>
