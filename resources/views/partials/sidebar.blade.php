        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                ...
                <li class="nav-dropdown">
                    <a href="https://accounts.spotify.com/authorize?response_type=code&state=&client_id=a7814781430f49b38051ef66eb2baa99&scope=user-read-playback-state%20user-modify-playback-state&redirect_uri=https%3A%2F%2Fmacrobyte.site%2Fmusica%2Fcallback" aria-expanded="false"><i class="la la-key"></i><span>Crear Token Spotify</span></a>
                </li>
            </ul>
        </nav>
    </div>
