...
<head>
    ...
    <link rel="stylesheet" href="{{asset('april/dist/css/style.css')}}">
                        ...
                        <h1 class="m-0">
                            <div class="contenedor">
                                <a href="#">
                                    ...
                                    <img src="{{asset('april/dist/images/logo.png')}}" width="80px">
                                </a>
                            </div>
                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                ...
                                <p class="section-paragraph">El equipo de <strong>MACROBYTE</strong> tiene como visión impulsar
                                     el desarrollo de software de alta calidad, satisfaciendo las necesidades de micros, 
                                     medianas y grandes compañías. Aplicando tecnologías recientes. Factores como  la 
                                     responsabilidad, talento humano e innovación son parte fundamentales que complementan los 
                                     pilares de nuestra organización.</p>
                            </div>
                            <div class="container-sm mx-auto">
                                <img src="{{asset('april/dist/images/build4k.gif')}}" class="imagencenter" style="position: fixed center" alt="">

                            </div>
                            <div class="container-sm">
                                <h2 class="section-title mt-0">MISION</h2>
                                <p class="section-paragraph">Somos profesionales en el desarrollo y manejo de software, 
                                    comprometidos a brindar confianza y mejorar la calidad de vida de nuestros clientes. Creada para 
                                    contribuir al desarrollo social del país, diseñando productos y servicios de alta competitividad, 
                                    con personal capacitado y  equipos de tecnología que son de 
                                    vital importancia para la producción de la compañía.</p>
                            </div>
                        </div>
						<div class="features-wrap">
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">DISEÑO AMIGABLE</h4>
                                    <p class="text-sm">Nos enfocamos en maquetar y realizar diseños agradables e intuitivos para los usuarios, para una navegación cómoda, rapida y segura, evitando cualquier problema que impida ver el contenido por el que accedió.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">ADAPTABLE Y COMODO</h4>
                                    <p class="text-sm">En cada uno de nuestros proyectos nos preocupamos por que el contenido sea flexible y adaptable a cualquier tipo de dispositivo existente hoy en día, desde un móvil de pantalla pequeña hasta una computadora de escritorio o una Smart tv.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">POTENTE y RAPIDO</h4>
                                    <p class="text-sm">Las tecnologias empleadas en cada uno de nuestros proyectos, son garantia de rapidez y seguridad, ademas de tener escalabilidad para tener cada vez mas servicios y contenido que ofrecer!</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">ORGANIZADO Y ACCESIBLE</h4>
                                    <p class="text-sm">Somos especialistas en el manejo de la información por lo que siempre tendrás todo organizado y con acceso rápido al contenido que desees ver.</p>
                                </div>
                            </div>
						</div>
                    </div>
			...
			<section class="testimonials section">
				...
				<div class="container">
					<div class="testimonials-inner section-inner">
						<h2 class="section-title mt-0 text-center">Nuestros Proyectos Independientes</h2>
						<div class="testimonials-wrap">
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="{{asset('april/dist/images/icon-512x512.png')}}" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0"><strong>Restonovo</strong> es nuestra primer plataforma moderna hecha 
                                                para restaurantes! Olvidate de usar papeles y escribir todo a mano, con Restonovo y su 
                                                interfaz intuitiva, puedes hacer pedidos desde cualquier dispositivo con impresiones de 
                                                boletas, facturas y comandas al instante ademas de ofrecer una interfaz para los clientes, 
                                                para tener el control de sus cuentas, reproducir musica dentro del 
                                                restaurante, hacer pagos online, ver la disponibilidad del menu en tiempo real, entre otras cosas!.
                                            </p>
										</div>
									</div>
							...
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="{{asset('april/dist/images/logo.png')}}" alt="Testimonial">
										</div>
										<div class="testimonial-body">
                                            ...
                                            Con la implementacion de pagos online, unirte a un curso o varios es muy sencillo, ademas puedes convertirte en un profesor, si tienes las aptitudes necesarias, para ganar comisiones por cada cliente que adquiera un curso de tu autoria.</p>
										</div>
									</div>
									<div class="testimonial-footer">
										<div class="testimonial-link">
											<a href="#">En fase de desarrollo.</a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="testimonial-main">
										...
										<div class="testimonial-body">
											<p class="mb-0"><strong>EcoByte</strong> es nuestra plataforma ecommerce para la venta de productos de toda clase, al por mayor o menor, con precios inigualables! 
                                                La caracteristica principal de esta plataforma es que puedes realizar compras de productos que se encuentran en tiendas internacionales 
                                            como Aliexpress, Alibaba, etc. Además de poder convertirte en un vendedor, con tu catalogo de productos propios y con clientes en todo el pais.</p>
										</div>
									</div>
									<div class="testimonial-footer">
										<div class="testimonial-link">
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            <h2 class="section-title mt-0">Contáctanos</h2>
                            <p class="section-paragraph">Nuestras redes sociales son la forma mas facil y comoda de encontrarnos para brindarte toda la informacion que necesites. Que esperas!</p>
                        </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="brand footer-brand">
							...
							<img src="{{asset('april/dist/images/logo.png')}}" class="imagenpeq"  alt="">
                    ...
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="https://www.facebook.com/macrobyte.tja/">
                                <img src="{{asset('april/dist/images/facebook.png')}}" class="imagenpeq"  alt="">
                            </a>
                        </li>
                        <li>
                            <a href="https://api.whatsapp.com/send?phone=59175140175&text=Me%20interesa%20saber%20mas%20de%20MACROBYTE!">
                                <img src="{{asset('april/dist/images/whatsapp.png')}}" class="imagenpeq"  alt="">
                               
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('april/dist/images/mensajero.png')}}" class="imagenpeq"   alt="">
                               
                            </a>
                        </li>
                    </ul>
                    <div class="footer-copyright">&copy; {{date('Y')}} Todos los derechos reservados</div>
                </div>
            </div>
        </footer>
    </div>
...
<script>
  ...
  (function(d, s, id) {
    ...
    <script src="{{asset('april/dist/js/main.min.js')}}"></script>
</body>
</html>
