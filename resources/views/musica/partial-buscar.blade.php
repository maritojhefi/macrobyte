                    ...
                    <div class="row no-gutters m-b-30">
                        ...
                        <div class="col">
                            <div class="m-l-10">
                                ...
                                <a href="#" wire:click="add('{{ $cancion['uri'] }}','{{$cancion['nombre']}}','{{$cancion['artista']}}','{{$cancion['foto']}}')" wire:loading.remove>  <small class="text-muted"><span class="badge badge-pill badge-secondary"><i class="font-size-22 v-align-middle zmdi zmdi-plus-circle zmdi-hc-fw text-white"></i>Añadir</span></small> </a> <br>
