            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                    <div class="card text-center p-20">
                        ...
                        @if ($imagenActiva)
                        <img src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->mergeString(Storage::disk('assets')->get('marios.jpeg'),'.'.$tamanoImagen)->size($tamano)->generate($url))}}" alt="">
                        @else
