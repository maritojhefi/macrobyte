...
<li><a href="pages.invoice-template.html"><span>Invoice Template</span></a></li>
                    ...
                    <li class="nav-dropdown active">
                        ...
                        <ul class="collapse in nav-sub" aria-expanded="false">
                            ...
                            <li class="active"><a href="components.dropdowns.html"><span>Dropdowns</span></a></li>
            ...
            <div class="content">
                <header class="page-header">
                    <div class="d-flex align-items-center">
                        <div class="mr-auto">
                            <h1 class="separator">Dropdowns</h1>
                ...
                <section class="page-content container-fluid">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <h5 class="card-header">Icon Dropdown</h5>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="dropdown">
                                        ...
                                        <div class="col">
                                            <div class="nav-item dropdown dropdown-menu-lg">
                                                <a href="javascript:void(0)" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                    <i class="icon dripicons-view-apps  text-primary"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right p-0">
                                                    <div class="dropdown-menu-grid">
                                                        <div class="menu-grid-row">
                                        ...
                                        <div class="col">
                                            <div class="nav-item dropdown dropdown-notifications dropdown-menu-lg">
                                                <a href="javascript:void(0)" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                    <i class="icon dripicons-bell text-accent"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <div class="card card-notification">
                                                        <div class="card-header">
                                        ...
                                        <div class="col">
                                            <div class="dropdown">
                                                <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="icon dripicons-information text-warning"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#">Action</a>
                                                    <a class="dropdown-item" href="#">Another action</a>
                                        ...
                                        <div class="col">
                                            <div class="dropdown">
                                                <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="icon dripicons-cart text-info"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#">Action</a>
                                                    <a class="dropdown-item" href="#">Another action</a>
                                        ...
                                        <div class="col">
                                            <div class="dropdown">
                                                <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="icon dripicons-download text-danger"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#">Action</a>
                                                    <a class="dropdown-item" href="#">Another action</a>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="demo-buttons--preview">
                                        <p class="f-w-400 m-b-10">Dropdown button</p>
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown button</button>
                                        ...
                                        <!-- /btn-group -->
                                        <p class="f-w-400 m-b-10 m-t-20">Dropdown button</p>
                                        <div class="btn-group dropdown">
                                            <a href="#" role="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown link</a>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <!-- /btn-group -->
                                        <p class="f-w-400 m-b-10 m-t-20">Dropdown States</p>
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-accent dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Accent</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <!-- /btn-group -->
                                        <p class="f-w-400 m-b-10 m-t-20">Dropdown Split States</p>
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-accent">Split Dropdown</button>
                                        ...
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-success">Split Dropdown</button>
                                        ...
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-info">Split Dropdown</button>
                                        ...
                                        <p class="f-w-400 m-b-10 m-t-20">Drop Variations</p>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <h5 class="card-header">Outline Style Dropdowns</h5>
                                <div class="card-body">
                                    <div class="demo-buttons--preview">
                                        <p class="f-w-400 m-b-10">Dropdown button</p>
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-secondary btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown button</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <p class="f-w-400 m-b-10 m-t-20">Dropdown button</p>
                                        <div class="btn-group dropdown">
                                            <a href="#" role="button" class="btn btn-primary btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown link</a>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <p class="f-w-400 m-b-10 m-t-20">Dropdown States</p>
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-accent btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Accent</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <!-- /btn-group -->
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-success btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Success</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <!-- /btn-group -->
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-info btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Info</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <!-- /btn-group -->
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-warning btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Warning</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <!-- /btn-group -->
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-danger btn-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Danger</button>
                                            <div class="dropdown-menu" >
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
                                                <a class="dropdown-item" href="#">Something else here</a>
                                        ...
                                        <p class="f-w-400 m-b-10 m-t-20">Dropdown Split States</p>
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-accent btn-outline">Split Dropdown</button>
                                            <button type="button" class="btn btn-accent btn-outline dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#">Action</a>
                                        ...
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-success btn-outline">Split Dropdown</button>
                                        ...
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-info btn-outline">Split Dropdown</button>
                                        ...
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-warning btn-outline">Split Dropdown</button>
                                        ...
                                        <div class="btn-group dropdown">
                                            <button type="button" class="btn btn-danger btn-outline">Split Dropdown</button>
